  ...
  const filters = [
    {
      id: 0,
      title: "by genre",
      options: ["men", "women", "non-binary", "trans", "other"],
    },
    {
      id: 1,
      title: "by date of birth",
      options: [1920, 1930, 1940, 1950, 1960, 1970, 1980, 1990, 2000],
    },
    {
      id: 2,
      title: "by place of birth",
      options: [
        "Lower Uele",
        "Equateur",
        "East Kasai",
    ...
    },
    {
      id: 5,
      title: " by publishers",
      options: ["publisher 1", "publisher 2", "publisher 3", "publisher 4"],
    },
  ];
  const sorting = [
